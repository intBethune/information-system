...
async function openEditDialog(item) {
    ...
    if (item) {
        ...
        form.elements.cur_sn.value = item.cur_sn ?? null;
        form.elements.cur_name.value = item.cur_name ?? "";
        form.elements.cur_sta.value = item.cur_sta ?? "";
        form.elements.cur_pla.value = item.cur_pla ?? "";
        form.elements.cur_no.value = item.cur_no ?? "";
        form.elements.cur_term.value = item.cur_term ?? "";
    } else {
        dialogTitle.innerText = "新建课程记录";
        form.elements.cur_name.value = null;
        form.elements.cur_sta.value = "";
        form.elements.cur_pla.value = "";
        form.elements.cur_no.value = "";
        form.elements.cur_term.value = "";
    }
...
async function renderEditDialog() {
    ...
    save_btn.onclick = (e) => {
        let data = {
            cur_sn: form.elements.cur_sn.value,
            cur_name: form.elements.cur_name.value,
            cur_sta: form.elements.cur_sta.value,
            cur_pla: form.elements.cur_pla.value,
            cur_no: form.elements.cur_no.value,
            cur_term: form.elements.cur_term.value,
        };
